...
/*   Updated: 2022/09/11 16:28:09 by abellakr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	translation_player(t_data *data)
{
	...
	if (data->k_x == 0)
		...
		data->x_translation = data->player->pos.x \
		* data->unit - fabs(data->k_x);
	else if (data->k_x < 0)
		data->x_translation = data->player->pos.x \
		* data->unit + fabs(data->k_x);
	if (data->k_y == 0)
		...
		data->y_translation = (data->player->pos.y \
		* data->unit) + fabs(data->k_y);
	else if (data->k_y > 0)
		data->y_translation = (data->player->pos.y \
		* data->unit) - fabs(data->k_y);
}
