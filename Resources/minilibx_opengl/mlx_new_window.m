...
- (int)	pixel_management
{
  ...
  glsl.loc_font_positioninwin = glGetUniformLocation(glsl.font_program, "fontposinwin");
  glsl.loc_font_positioninatlas = glGetUniformLocation(glsl.font_program, "fontposinatlas");
  ...
  glsl.loc_font_positionition = glGetAttribLocation(glsl.font_program, "position");
  //      printf("err? 0x%x\n", glGetError());
...
- (void) mlx_gl_draw_font:(mlx_img_list_t *)img andCtx:(mlx_img_ctx_t *)imgctx andX:(int)x andY:(int)y andColor:(int)color glyphX:(int)gx glyphY:(int)gy
{
  ...
  glUniform2f(glsl.loc_font_positioninwin, x, size_y - 1 - y);
  glUniform2f(glsl.loc_font_positioninatlas, gx, gy);
