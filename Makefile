...
# Srcs
SRCS = $(SOURCE)main.c  $(SOURCE)_error.c $(SOURCE)checkargs.c  $(SOURCE)player.c $(SOURCE)Hooks_and_Events.c $(SOURCE)map.c $(SOURCE)ray_cating.c $(SOURCE)render_wall.c $(SOURCE)ft_reassign.c $(SOURCE)draw_ceilling_floor.c $(SOURCE)draw_line.c $(SOURCE)draw__fov.c $(SOURCE)wall_texture.c
